package com.animehub.otakuvortex.presentation.adapters.anime
...
class AnimeGenreRecyclerViewAdapter: ListAdapter<Genre, AnimeGenreRecyclerViewAdapter.GenreViewHolder>(DiffUtily()) {
